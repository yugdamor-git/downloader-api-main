...
async function fetchDownloadUrl(cid,id,quality,contentType)
    {
        ...
        formData.append("format",contentType)
...
const Video = ({currentVideoData,contentType}) => {
  ...
  const getDownloadButton = async(currentVideoData,contentType) => {
    ...
    const res = await fetchDownloadUrl(currentVideoData.cid,currentVideoData.id,quality,contentType)
  ...
  return (
    <div className="my-2 p-[20px] custom:min-h-[400px] min-h-[470px] border-[1px] border-solid border-[#00000020] bg-[#e9ecef] mt-[50px] sm:flex  sm:gap-8 mx-[24px] lg:max-w-[920px]  lg:mx-auto sm:min-h-[250px]">
      <img
      ...
      <div className="sm:w-[75%] text-left">
        ...
        <p className="text-left">{Math.round(currentVideoData.duration/60)} min</p>
        <hr
          className="my-[.3rem]"
          style={{
          ...
          <div className="btn-group flex">
            ...
            >
                ...
                {contentType == "video" &&
                  ...
                  (
                     <option key={item} value={item}>{item}p</option>
                  ))
                }
                ...
                {contentType == "audio" &&
                  ...
                  (
                     <option key={item} value={item}>{item}kbps</option>
                  ))
                }
        ...
        {showDownload && (
          <div className="download btn text-left">
            <a
              type="button"
              className="text-white bg-green-600  hover:bg-green-500  font-medium rounded-lg text-sm px-5 py-2 text-center mr-2 mb-2"
              href={video}
              download
            >
              Download
            ...
            <button
              type="button"
              className="text-white bg-yellow-500   hover:bg-yellow-400  font-medium rounded-lg text-sm px-5 py-2 text-center mr-2 mb-2"
              onClick={NextHandler}
            >
              Convert next
            </button>
